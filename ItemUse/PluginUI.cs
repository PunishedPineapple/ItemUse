...
internal sealed class PluginUI : IDisposable
{
	public PluginUI( Plugin plugin, Configuration configuration, IDalamudPluginInterface pluginInterface )
	{
		...
		Window_Debug_ClassJob = new( mPlugin, this, configuration );
		...
		mWindowSystem.AddWindow( Window_Debug_ClassJob );
	}
	...
	internal Window_Debug_ClassJob Window_Debug_ClassJob { get; private set; }
}